...
class SamplingState(State):
    ...
    def __init__(self, *initial_state: int) -> None:
        ...
        self.interferometer: npt.NDArray[np.complex128] = \
    ...
    def _apply_passive_linear(
        self, U: npt.NDArray[np.complex128], modes: Tuple[int, ...]
    ) -> None:
        r"""
    ...
    def _apply_loss(
        self, transmissivity: npt.NDArray[np.complex128], modes: Tuple[int, ...]
    ) -> None:
        self.is_lossy = True
    ...
    def _apply_matrix_on_modes(
        self, matrix: npt.NDArray[np.complex128], modes: Tuple[int, ...]
    ) -> None:
