...
class Beamsplitter5050(_PassiveLinearGate):
    ...
    This gate corresponds to the successive application of a phaseshifter gate
    :class:`Phaseshifter` with parameter $\phi = \pi$ on the second mode and a regular
    beamsplitter gate :class:`Beamsplitter` with parameters
    $\theta = \frac{\pi}{4}$ and $\phi = 0$.
