...
def test_get_xp_string_expectation_value_against_fock_states():
    ...
    expected_fock = f_state._xp_string_expectation(indices)
    expected_pure = p_state._xp_string_expectation(indices)
...
def test_get_xp_string_expectation_value_random():
    """Verify that a Gaussian state returns the same xp-string expectation as
    the Fock simulator for a randomly chosen list of quadrature indices."""
    d = 2
