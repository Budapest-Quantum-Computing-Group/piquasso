...
pytestmark = pytest.mark.benchmark(
    group="application_feature_vector_calculation_exact",
)
...
def piquasso_benchmark(
    ...
    def func():
        ...
        result.feature_vector_events(nx.Graph(adjacency_matrix), [2, 4], 2)
...
def strawberryfields_benchmark(
    ...
    @benchmark
    def func():
        similarity.feature_vector_events(nx.Graph(adjacency_matrix), [2, 4], 2)
