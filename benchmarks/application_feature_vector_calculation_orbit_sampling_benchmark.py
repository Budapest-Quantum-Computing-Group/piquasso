...
pytestmark = pytest.mark.benchmark(
    group="application_feature_vector_calculation_orbit_sampling",
)
...
def piquasso_benchmark(
    ...
    def func():
        ...
        result.feature_vector_orbits_sampling([[1, 1], [2], [1, 1, 1, 1], [2, 1, 1]])
...
def strawberryfields_benchmark(
    ...
    def func():
        ...
        similarity.feature_vector_orbits_sampling(samples, [[1, 1], [2], [1, 1, 1, 1], [2, 1, 1]])
