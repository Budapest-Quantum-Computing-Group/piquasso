...
pytestmark = pytest.mark.benchmark(
    group="application_dense_subgraph_search_with_15_nodes",
)

def piquasso_benchmark(benchmark, adj_matrix_15):
    @benchmark
    def func():
        ...
        result.dense_search(subgraphs, TA_graph, 8, 10, max_count=3)


def strawberryfields_benchmark(benchmark, adj_matrix_15):
    @benchmark
    def func():
        adjacency_matrix = adj_matrix_15
        TA_graph = nx.Graph(adjacency_matrix)
        ...
        subgraph.search(subgraphs, TA_graph, 8, 10, max_count=3)
