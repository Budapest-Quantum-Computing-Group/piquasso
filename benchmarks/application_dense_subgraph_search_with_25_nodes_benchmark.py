...
pytestmark = pytest.mark.benchmark(
    group="application_dense_subgraph_search_with_25_nodes",
)
...
def piquasso_benchmark(benchmark, adj_matrix_25):
    ...
    def func():
        ...
        result.dense_search(subgraphs, TA_graph, 12, 15, max_count=3)
...
def strawberryfields_benchmark(benchmark, adj_matrix_25):
    ...
    def func():
        ...
        subgraph.search(subgraphs, TA_graph, 12, 15, max_count=3)
