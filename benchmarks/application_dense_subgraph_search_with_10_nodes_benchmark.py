...
pytestmark = pytest.mark.benchmark(
    group="application_dense_subgraph_search_with_10_nodes",
)

def piquasso_benchmark(benchmark, adj_matrix_10):
    @benchmark
    def func():
        pq.constants.seed(40)
        adjacency_matrix = adj_matrix_10
        ...
        result.dense_search(subgraphs, TA_graph, 4, 6, max_count=3)


def strawberryfields_benchmark(benchmark, adj_matrix_10):
    @benchmark
    def func():
        adjacency_matrix = adj_matrix_10
        TA_graph = nx.Graph(adjacency_matrix)
        ...
        subgraph.search(subgraphs, TA_graph, 4, 6, max_count=3)
